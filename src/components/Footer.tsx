          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">
                <span className="text-purple-400">Email:</span> contact@yourdomain.com
              </li>
              <li className="text-gray-400">
                <span className="text-purple-400">Phone:</span> +1234567890
              </li>
              <li className="text-gray-400">
                <span className="text-purple-400">Location:</span> Your Location
              </li>
            </ul>
          </div>
        </div>
